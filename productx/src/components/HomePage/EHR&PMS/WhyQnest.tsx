...
//         {/* Title Section - Visible at Top, Static */}
//         <div className="absolute top-0 left-0 right-0 z-10 pt-24 pb-12">
//           <div className="text-center max-w-3xl mx-auto px-6">
//             <h2 className="text-[3.5rem] font-bold text-[#1F4D3B] mb-5 leading-tight">
//               Why <span className="relative inline-block">
//                 Qnest
//                 <span className="absolute left-0 right-0 bottom-2 h-1 bg-[#1F4D3B]"></span>
//               </span>
//             </h2>
...
//                   }}
//                 >
//                   <div className="bg-white rounded-[2rem] p-14 shadow-xl min-h-[550px] flex flex-col">
...
//                 {/* Card 2 - Middle - Already at top position */}
//                 <div className="lg:col-span-4 lg:mt-0">
//                   <div className="bg-white rounded-[2rem] p-14 shadow-xl min-h-[600px] flex flex-col">
//                     <h3 className="text-[4.5rem] font-bold text-[#1F4D3B] leading-none mb-5">
//                       126+
//                     </h3>
//                     <p className="text-[1.7rem] font-semibold text-[#1F4D3B] mb-auto leading-tight">
