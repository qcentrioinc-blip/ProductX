...
const strokeProgress = Math.max(
  ...
  return (
   ...
   <section
  ref={sectionRef}
  className="relative hidden xl:block dark:bg-[#141414] bg-white z-30"
  style={{ height: "420vh" }}
>

      <div className="sticky top-20 h-[100vh] xl:[80vh] flex flex-col items-center overflow-hidden z-30 border-l-[30px] dark:bg-[#141414] border-[#008280] bg-white">
...
"
  ...
  return (
    ...
    <div className="xl:hidden dark:bg-[#141414] bg-white px-6 py-6 xl:py-10">
  {/* Header */}
