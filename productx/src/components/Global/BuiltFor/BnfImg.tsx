    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div className="w-full max-w-[500px] aspect-square lg:max-w-max-w-none lg:aspect-auto lg:absolute lg:top-[120px] lg:left-[550px] lg:w-[450px] lg:h-[400px] xl:max-w-none xl:aspect-auto xl:absolute xl:top-[200px] xl:left-[880px] xl:w-[700px] xl:h-[600px]">
                        <img
                            src={content.imgSrc}
