  ...
  return (
    <section className="relative w-full h-full overflow-hidden bg-gradient-to-br from-[#0a0f3c] via-[#0b1a6b] to-[#0a2fa4]">
      <div className="relative">
        <div className="mx-10 lg:pt-52 grid max-w-8xl grid-cols-1 items-center gap-12 px-10 pb-48">
          {/* Text Content */}
          <motion.div
          ...
          >
            ...
            <img
              ...
              className="w-[800px] absolute pb-4 z-10 right-16  bottom-10 -scale-x-110 scale-y-110"
            />
          </motion.div>
          
          <img src="/AIProduct/Azure.png" alt="Azure Logo" className="absolute top-40 right-[33%] h-18 w-32 object-contain" />
          <img src="/AIProduct/Azure2.png" alt="Azure Logo" className="absolute top-64 left-[75%] h-24 w-32 object-contain" />
          <img src="/AIProduct/Money Profit.png" alt="Azure Logo" className="absolute top-66 right-20 h-20 w-32 object-contain" />
        </div>
      </div>
      
      {/* Rectangles at bottom with more gap */}
      <div className="absolute bottom-0 left-20 mb-10 flex gap-6 pb-0">
