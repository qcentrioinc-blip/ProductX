...
const ComparePrice = () => {
  ...
  >
    ...
    />
                        ...
                        <div className="h-full p-6 md:p-[40px] border border-[#E7EBFF] rounded-[26px] bg-white shadow-[0px_26px_40px_0px_#BCCAFF21] flex flex-col relative overflow-hidden group">
                            ...
                            <div className="relative z-10 flex flex-col h-full">
                                <div className="absolute top-0 right-0 lg:right-[-4px] lg:top-[-30px] xl:top-[2px]">
                                    <span className="bg-white/20 backdrop-blur-sm text-white text-xs font-medium px-3 py-1 rounded-full border border-white/40">
                                        Best offer
                                    </span>
                                </div>

                                <div className="h-auto min-h-[120px] flex flex-col justify-start gap-3 md:gap-4 mb-2 border-b border-white">
                                ...
                                <div className="flex-1 flex flex-col justify-between py-4 md:py-6">
                                    {features.map((feature, index) => (
                                        <div key={index} className="flex items-center justify-center min-h-[50px] py-2 md:py-0 border-b border-white">
