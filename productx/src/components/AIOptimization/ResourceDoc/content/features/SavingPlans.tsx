...
<img className="pl-16" src="/AIOptimization/SavingPlans1.png" alt="Savings Plan Visualization"/>
...
<img className="pl-16 h-[650px] w-[80%]"  src="/AIOptimization/SavingPlans2.png" alt="Savings Plan Visualization"/>
