...
const SavingPlans: React.FC = () => {
 ...
 <p className="font-quicksand dark:text-white  text-base text-gray-700 leading-relaxed">The Savings Plan Designer helps you make data-driven decisions and run what-if analyses to optimize savings plan strategy. Key components include Visualizations, Slicers, and Resource-level Details.  </p>
  ...
  <h3 className="font-quadran   dark:text-white   text-xl lg:text-2xl my-4">  Visualizations </h3>
...
<div className="overflow-x-auto xl:pl-16 mt-6">
  <table className="min-w-full border border-gray-300 text-left font-quicksand">
    ...
    <tbody>
     ...
     <h3 className="font-quadran    text-xl lg:text-2xl my-4 dark:text-white ">   Designer </h3>
...
<h2 className="font-quadran   text-xl md:text-2xl lg:text-3xl my-4 dark:text-white ">Frequently Asked Questions </h2>

   <h3 className="font-quadran    text-xl lg:text-2xl my-4 dark:text-white ">1. Why choose Savings Plans over Reserved Instances? </h3>
...
2. Can I commit to multiple Savings Plans?   </h3>
  <p className="font-quicksand text-base dark:text-white text-gray-700 leading-relaxed">Yes. You can create multiple Savings Plan commitments over time. This lets you start with a smaller amount and gradually increase your coverage as needed.   </p>
    ...
    <h3 className="font-quadran    text-xl dark:text-white lg:text-2xl my-4">3. Which Azure services are eligible for a Savings Plan?  </h3>
