...
const AddingService: React.FC = () => {
  ...
  <img className="pl-16 " src="/AIOptimization/Adding1.png" alt="" />
  ...
  <img className="pl-16 " src="/AIOptimization/Adding2.png" alt="" />
  ...
  <img className="pl-16 " src="/AIOptimization/Adding3.png" alt="" />
