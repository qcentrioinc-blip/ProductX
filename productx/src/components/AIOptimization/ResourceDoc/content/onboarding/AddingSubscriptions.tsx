...
const AddingSubscriptions: React.FC = () => {
  ...
  <img  className="pl-16 " src="/AIOptimization/AddingSubs1.png" alt="" />
  ...
  <img   className="pl-16 " src="/AIOptimization/AddingSubs2.png" alt="" />
  ...
  <img  className="pl-16 " src="/AIOptimization/AddingSubs3.png" alt="" />
