  ...
  return (
    <div className="space-y-4">
      ...
      <p>
        ...
        services that help organizations automate processes, gain insights, 
        and make data-driven decisions.
        <div className="bg-gray-100 rounded-lg mt-4 border-l-8">
<p className="p-4">The Daily, Monthly, and Annual savings is the amount you would realize by implementing the recommendation and not the full cost of the resource.</p>
