...
if (currentPath === "/industries/high-tech/resources") {
  ...
  return (
    ...
    >
      <div className=" sm:pb-10 lg:pb-0 ">
        <div className="flex flex-col max-8xl  pl-4 lg:flex-row items-center lg:items-start justify-between relative">
         
          {/* Vertical Dashed Separator (visible on large screens only) */}
          <div
            className="absolute inset-y-0 left-1/2 -translate-x-1/2 border-1 border-solid border-white hidden lg:block"  
            style={{
              height: '100%',
              borderLeftWidth: '3px',  
          ...
          <div
            className="w-full lg:hidden border-t-[3px] border-white my-4"  
            style={{
          ...
          <div className="w-full lg:w-1/2 h-64 lg:h-[500px] flex  sm: lg:pt-0 items-center justify-center relative">
            <img
              src="/HighTech/Careers/footer.png"
