...
const Content: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#042f2e] py-16 px-4 md:px-16 lg:px-32 mt-4 lg:pt-32">
      {/* Page Heading */}
      <H2EHR className=" text-gray-900 dark:text-white mb-8">
        Privacy Policy
      </H2EHR>
      ...
      <section className="mt-6 space-y-6">
        <H3EHR className=" text-gray-800 dark-text-white">Information Collected</H3EHR>
      ...
      <section className="mt-6 space-y-6">
        <H3EHR className=" text-gray-800 dark-text-white">How Information is Used</H3EHR>
        <P className="text-gray-700 leading-relaxed">
      ...
      <section className="mt-6 space-y-6">
        <H3EHR className=" text-gray-800 dark-text-white">Sharing and Disclosure</H3EHR>
        <P className="text-gray-700 leading-relaxed">
      ...
      <section className="mt-6 space-y-6">
        <H3EHR className=" text-gray-800 dark-text-white">User Choices</H3EHR>
        <P className="text-gray-700 leading-relaxed">
