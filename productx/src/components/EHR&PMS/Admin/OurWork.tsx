...
const OurWork = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      text: "Remove any spreadsheet work for reports. Get instant financial and appointment analytics with a few clicks. ",
  ...
  return (
    <div
  ref={containerRef}
  className="flex flex-col items-center justify-center py-20 px-4 relative bg-white"
>
