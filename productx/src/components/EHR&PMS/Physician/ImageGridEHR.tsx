...
const ImageGridEHR = () => {
  ...
  return (
    <div className="h-full lg:min-h-screen bg-gradient-to-br from-slate-50 to-stone-100 dark:bg-gradient-to-br dark:from-[#042F2E] dark:to-[#042f2e] py-16 px-4 sm:px-6 lg:px-8">
  ...
  "
              ...
              <div className="relative z-10 h-full 
                ...
                <H3EHR className="mt-10 inline-block relative">
                  Built For Clinicians
                  <span className="absolute left-0 -bottom-2 w-44 md:w-56 lg:w-66 xl:w-72 h-[2px] bg-[#141414]" />
                </H3EHR>


                <p className="max-w-md  font-quicksand text-[18px] font-bold mt-24  lg:mt-20 leading-relaxed">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="relative h-64 md:h-80 lg:h-90 bg-[#EEDA68] rounded-4xl overflow-hidden shadow-lg p-8 md:p-10 flex flex-col justify-end">
              ...
              <p className="text-sm md:text-base lg:text-[18px]  font-quicksand text-black">
