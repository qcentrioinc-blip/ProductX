...
const Features = () => {
  ...
  return (
    <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-8xl xl:mx-10 mx-6">
          ...
          <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-8 mb-12">
            ...
            <div className="relative w-full lg:w-auto lg:flex-shrink-0">
              <div className="relative  w-full ">
                  ...
                  <img src="/Physician/GreenRect.svg" alt="ehr and pms"/>
  ...
  Duis aute irure
            ...
            <div className="flex-1 text-left xl:text-right">
              <H2 className="text-[#008280] leading-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10">
            {features.map((feature) => (
              <div key={feature.id} className="flex flex-col">
                {/* Icon Circle */}
                <div className="w-12 h-12 md:w-14 md:h-14 bg-gray-200 rounded-full mb-4 flex-shrink-0"></div>
