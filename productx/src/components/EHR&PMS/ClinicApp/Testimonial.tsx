  ...
  return (
    <div className="w-full bg-[#EFEFEF] py-12 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
       ...
       <div ref={sectionRef} className="relative mt-32">
  {/* ✅ Grid Container */}
  <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-start z-10">
    {[1, 2, 3, 4].map((item, index) => (
      <div key={item} className="relative flex flex-col items-start space-y-4    transition-all duration-300 min-h-[300px]">
        {/* ✅ Card content */}
        ...
        {/* ✅ Vertical Line Between Cards (except last) */}
        {index !== 3 && (
          <div
            className="absolute top-0 right-0 w-[1px] bg-[#166D48] origin-top hidden lg:block"
            style={{
