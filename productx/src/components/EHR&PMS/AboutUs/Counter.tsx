...
const Counter = () => {
  ...
  return (
   <section
  ref={ref}
  className="relative flex flex-col  lg:items-center   py-28 overflow-hidden"
>
 
   <div className="absolute inset-0 bg-gradient-to-b from-[#EAFFF0] to-[#EDE4CA]"></div>

  {/* Content Wrapper */}
  <div className="relative z-10 flex flex-col max-w-8xl px-10    justify-center">
    {/* Heading */}
    <H2 className="font-semibold  text-left lg:text-center mb-16 text-gray-800 leading-snug">
      Sed ut perspiciatis Unde Seduo  <br /> ut perspiciatis
    </H2>
    ...
    <div className="relative flex flex-col  lg:flex-row items-center   sm:gap-4 md:gap-0 w-full max-w-8xl  lg:px-6 ">
      {/* Left Box */}
      <motion.div
        className="relative bg-[#166D48] w-[100%] rounded-l-lg  lg:px-0 px-2 h-[320px] flex items-center justify-center overflow-hidden"
...
<div className="hidden lg:flex lg:flex-row items-center justify-center mt-12 gap-14 text-center">
  ...
  {/* Counter 1 */}
  <div>
    <h2 className="lg:text-6xl text-4xl font-bricolage lg:-mt-44 font-bold text-black">
      {isInView && <CountUp end={56} duration={2} suffix="%" />}
    </h2>
