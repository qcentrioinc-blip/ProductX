      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="grid md:grid-cols-[1fr_2fr] gap-8">
            ...
            <div className="relative rounded-2xl bg-[#E7F1FF] overflow-hidden border border-gray-300 min-h-[180px] sm:min-h-[200px] md:min-h-[230px] lg:min-h-[260px]">
...
/>
            ...
            {/* Card 2 */}
            <div className="relative bg-[#F2F2F2] rounded-2xl px-4 xl:px-10 border border-gray-300 flex items-center justify-between min-h-[180px] sm:min-h-[200px] md:min-h-[230px] lg:min-h-[260px]">
    ...
    <P>
      ...
      with role-based access controls and audit trails.
          ...
          <div className="grid md:grid-cols-[2fr_1fr] gap-8">
            ...
            {/* Card 3 */}
            <div className="relative bg-white rounded-2xl px-4 xl:px-10 border border-gray-300 flex items-center justify-between min-h-[180px] sm:min-h-[200px] md:min-h-[230px] lg:min-h-[260px]">
