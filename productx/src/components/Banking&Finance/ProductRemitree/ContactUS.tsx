...
useEffect(() => {
  ...
  return (
    ...
    */
    <div
      ref={targetRef}
      className="relative z-50  xl:pb-10 xl:pt-32  overflow-hidden  pointer-events-auto bg-white"
      id='ContactUs'
    >
      {/* TOAST */}
      {toast && (
      ...
      <motion.div
        ...
        */
        className="hidden xl:block overflow-visible bg-white"
      >
...
>
                    ...
                    <input
                      ...
                      className={`w-full px-5 py-3.5 rounded-full font-quicksand placeholder-black border-2 
                        ...
                        ${isEmailValid ? 'border-[#2B68C3] focus:border-[#2B68C3]' : 'border-gray-200 focus:border-blue-500'}`}
                    />
