...
export default function ThreeCards() {
    ...
    <div className="max-w-8xl mx-auto flex items-center justify-center dark:bg-black bg-white">
      ...
      <div className="hidden lg:flex w-full max-w-8xl mx-10 px-10 py-10 flex-col gap-8">
        ...
        <div className="flex w-full gap-8 h-auto xl:h-[458px]">
          ...
          >
            <div className="w-18 h-18 bg-[#006C49] rounded-full shrink-0 flex items-center justify-center">
  ...
  >
     <div className="w-14 h-14 bg-[#006C49] rounded-full shrink-0 flex items-center justify-center">
              <img src={card.icon} alt="" className="object-contain h-8 w-8"/>
            </div>

    <div className="flex flex-col gap-2">
      <H4 className="dark:text-[#006C49]"
      >
        {card.title}
      </H4>
    ...
    {cards.map((card, idx) => (
          ...
          >
          <div className="w-10 h-10 bg-[#006C49] rounded-full shrink-0 flex items-center justify-center">
