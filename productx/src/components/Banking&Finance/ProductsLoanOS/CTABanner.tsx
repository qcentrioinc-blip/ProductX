          ...
          <div className="relative z-10 flex flex-col justify-center px-6 sm:px-10 lg:px-14 py-10 w-full lg:w-xl">
            <div className="relative w-full max-w-[450px]  mx-auto xl:mx-0 xl:absolute lg:left-[60%] xl:left-52 xl:top-14">
              ...
              <div className="relative p-7 sm:p-9">
                <h3  className="text-white font-bricolage text-[24px] lg:text-[43px] font-bold leading-tight mb-4">
                ...
                <button className="flex items-center gap-3 bg-white text-[#0F2557] font-bold text-sm px-5  py-2 lg:py-4 rounded-lg hover:bg-blue-50 transition-colors duration-200">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#102C56" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="11" cy="11" r="8" /><path d="m21 21-4.35-4.35" />
                  </svg>
                  <h3 className="font-bricolage  text-[18px] lg:text-[28px] text-[#141414]">Explore LOS Today</h3>
                </button>
              </div>
            </div>
          </div>
