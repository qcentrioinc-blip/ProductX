      ...
      >
        <defs>
          <linearGradient id="chGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#5CB8E6" />
            <stop offset="100%" stopColor="#2B68C3" />
          </linearGradient>
        </defs>
  ...
  return (
    <div className="w-full relative   bg-[#E7E7E7] dark:bg-black flex flex-col items-center px-4 xl:px-0   pt-10 pb-20 ">
      ...
      <div className="flex  flex-col xl:flex-row items-center    gap-4 xl:gap-6 w-full max-w-7xl">
        {/* Left Circle */}
        <div className="bg-[#2B68C3] text-white rounded-full w-60 h-60  md:w-72 md:h-72 xl:w-76 xl:h-76 flex flex-col items-center justify-center -lg">
        ...
        {/* Middle Box */}
        <div className="bg-gradient-to-b from-[#85AEFF] via-[#2B68C3] to-[#2B68C3] rounded-3xl p-10 w-72 md:w-80 flex flex-col gap-4">
          {[
            "Gap",
            "Duration",
            "NII",
    ...
    <div className="bg-white rounded-2xl text-center p-6  w-72 flex flex-col gap-5">
          {[
            ...
            <div key={index} className=" text-[18px] xl:text-[24px] font-quicksand font-semibold ">
              {item}
              <div className="mt-2 h-[3px] w-full rounded-4xl  bg-[#2B68C3] opacity-80" />
            </div>
          ))}
        </div>
      </div>
