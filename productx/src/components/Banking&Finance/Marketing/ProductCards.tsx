...
export const App: React.FC = () => {
  ...
  return (
    ...
    <section ref={sectionRef} className="w-full py-10 px-6 sm:px-10 lg:px-[80px]">
      ...
      <div
        className="
          sticky top-[60px] z-30 bg-white/50 py-3 mb-5
          ...
          {categories.map((c) => (
            <button
              ...
              className={`
                ...
                rounded-full border border-gray-200 transition duration-300 whitespace-nowrap font-medium
                ${
                  c === selectedCategory
                    ? "bg-[#5d8ef0] text-white shadow-xl border-[#8495ae] scale-[1.03]"
                    : "bg-white text-gray-700 hover:shadow-lg hover:border-gray-400"
                }
              `}
            >
              {c}
