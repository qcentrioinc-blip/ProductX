...
<div
  ...
  style={{
    background: "linear-gradient(180deg, #FFFFFF 0%, #DEE8F9 45%, #7CA2E4 100%)"
  }}
>
          ...
          <div className="absolute top-0 right-0 w-[280px] h-[280px] rounded-full border-[5px] border-[#FED60033] opacity-50 translate-x-1/4 -translate-y-1/4 sm:w-[350px] sm:h-[350px] md:w-[450px] md:h-[450px] lg:w-[550px] lg:h-[550px] xl:w-[600px] xl:h-[600px] md:border-[8px] xl:border-[8px] md:opacity-70"></div>
