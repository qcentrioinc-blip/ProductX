...
// <div
//   className="relative w-full bg-linear-to-b from-[#c3c1f1] via-[#8f8aee] to-[#5e56f8] flex flex-col items-start md:items-start pb-[25vh] md:pb-[30vh] lg:pb-[35vh] xl:pb-[40vh]"
 
// >
 
//           {/* Accent circles (unchanged) */}
//           <div className="absolute top-0 right-0 w-[320px] h-80 rounded-full border-[6px] border-[#7087e933] opacity-50 translate-x-1/4 -translate-y-1/4 sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] xl:w-[700px] xl:h-[700px] md:border-10 xl:border-[12px] md:opacity-70"></div>
...
//             <H1 className="text-gray-900 text-2xl sm:text-3xl md:text-4xl lg:text-[2.6rem] xl:text-5xl leading-tight">
//               Lorem ipsum dolor , consectetur adipis
//             </H1>
//             <P className="max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-3xl text-sm sm:text-base md:text-lg lg:text-[1.05rem] xl:text-lg">
//               Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
//             </P>
...
//             {/* Desktop/Larger Screens Original Image Layout (hidden until 'xl' breakpoint) */}
//             <div className="
//               hidden xl:flex
