const BlueBox = () => {
    return (
        <div className="relative w-full overflow-hidden xl:w-7xl xl:mx-auto xl:flex xl:h-[730px]">
            ...
            <div className="
                ...
                lg:p-16
                xl:w-[870px] xl:min-w-[870px] xl:h-[730px]
            ...
            ">
                ...
                <div className="flex flex-col gap-6 sm:flex-row sm:items-stretch xl:items-stretch">
            ...
            <div className="hidden xl:block absolute bottom-0 2xl:right-0 xl:right-0 z-10 w-[500px] h-auto pointer-events-none">
                <img
                    src="/BNFCos/cta.webp"
