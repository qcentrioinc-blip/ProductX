        ...
        <div className="max-w-8xl px-10 mx-10 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-12">
            ...
            <article className="prose space-y-8 prose-gray max-w-none">
              ...
              <P className="mb-2">
                FinCore Banking Solutions ("we," "us," or "our") is committed to protecting the privacy and security of your personal and financial information. This Terms and Conditions describes how we collect, use, disclose, and safeguard information obtained through our banking platforms, mobile applications, websites, and related financial services (collectively, the "Services"). By using our Services, you agree to the terms of this Terms and Conditions. If you do not agree, please discontinue use of our Services immediately.
              </P>
