                ...
                <div className="max-w-7xl w-full mx-auto flex flex-col lg:flex-row lg:items-start">
                    ...
                    <div className="lg:hidden w-full mb-8">
                        ...
                        <div ref={navScrollRef} className="flex gap-3 overflow-x-auto pb-3 scrollbar-hide scroll-smooth">
                            {navItems.map((item, index) => (
                                <button
                                    ...
                                    className={`font-bricolage font-semibold text-lg md:text-xl text-[#006C49] whitespace-nowrap select-none transition-opacity duration-300 cursor-pointer bg-transparent border-none px-0 ${activeIndex === index ? "opacity-100" : "opacity-55"
                                        }`}
                                >
                                    {item}
                                </button>
                        ...
                        <div className="w-full h-[3px] rounded-full overflow-hidden mt-2 flex">
                            <div
                                className="h-full bg-[#006C49] rounded-l-full transition-all duration-400"
                                style={{
                    ...
                    <div className="hidden lg:flex items-start shrink-0">
                        ...
                        >
                            {navItems.map((item, index) => (
                                ...
                                >
                                    <span
                                        className={`font-bricolage font-semibold text-[32px] leading-none  text-[#006C49] select-none transition-opacity duration-300 flex items-center whitespace-nowrap ${activeIndex === index ? "opacity-100" : "opacity-55"
                                            }`}
                                    >
                                        {item}
                                    </span>
                        ...
                        >
                            <div
                                className="w-[3px] bg-[#006C49] rounded-t"
                                style={{
                    ...
                    <div className="flex flex-col items-center justify-center gap-6 md:gap-8 xl:gap-[22px] w-full lg:flex-1 lg:ml-10 xl:ml-[80px] overflow-hidden">
                        ...
                        <div className="flex flex-col items-center gap-5 md:gap-6 xl:gap-[29px] w-full max-w-4xl px-2 md:px-0">
                            ...
                            {/* Heading */}
                            <h2
                                className="w-full text-center dark:text-white text-[#006C49] m-0 font-bricolage font-semibold leading-tight md:leading-none"
