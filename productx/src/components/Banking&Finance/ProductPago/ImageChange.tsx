      ...
      <div className="max-w-7xl px-6  xl:px-6 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-14 items-center">
          ...
          <div className="space-y-10">
            ...
            <div>
              <H4 className="text-xl dark:text-[#006C49] font-semibold mb-3">Complexity</H4>
            ...
            <div>
              <H4 className="text-xl font-semibold mb-3 dark:text-[#006C49]">Security</H4>
              <P className="text-[#141414] dark:text-white  ">
            ...
            <div>
              <H4 className="text-xl font-semibold mb-3 dark:text-[#006C49]">Cost</H4>
              <P className="text-[#141414] dark:text-white  ">
          ...
          <div className="space-y-6">
            ...
            <H3 className="text-2xl md:text-3xl dark:text-[#006C49] font-semibold leading-snug">
