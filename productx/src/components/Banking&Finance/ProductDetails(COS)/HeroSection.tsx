  ...
  return (
    <section ref={sectionRef} className="relative w-full flex items-start justify-center overflow-hidden pt-0 mt-0">
      ...
      <div className="absolute inset-0 hidden md:flex">
        <div className="w-1/2 bg-[#006C49]" />
        <div className="w-1/2 bg-[#006C49] relative">
          {/* Desktop Circles */}
          <div
      ...
      <div className="absolute inset-0 flex flex-col md:hidden">
        <div className="flex-1 bg-[#006C49]" />
        <div className="flex-1 bg-[#006C49] relative">
      ...
      <div className="relative w-full items-center flex flex-col md:flex-row px-4 sm:px-8 py-0 md:py-0 max-w-[1440px] mx-auto gap-4 z-10">
        ...
        {/* Image Section */}
        <div className="relative w-screen md:mt-22  md:w-1/2 bg-[#006C49] md:bg-transparent pb-5 flex justify-center">
          {/* Mobile layout */}
          <motion.div
