...
const CheckIcon = () => (
  <svg
    className="w-5 h-5 text-[#006C49] mr-3 mt-0.5 flex-shrink-0"
    fill="none"
    stroke="currentColor"
    strokeWidth={2.5}
    viewBox="0 0 24 24"
...
const ImgTextSec = () => {
  ...
  <div >
    <H2 className="max-w-4xl">
      <span className="text-[#006C49]">Powerful Features of </span>
                          ...
                          <H4 className="flex items-center text-base">
                            <svg
                              className={`w-5 h-5 mr-3 flex-shrink-0 transition-transform duration-500
                                ${isActive ? "rotate-90 text-[#006C49]" : "text-gray-400"}`}
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                            ...
                            <span>
                              <span className="text-[#006C49]">{data.title.part1}</span>
