...
const productDescriptions: Record<string, string> = {
  "Agile Development": "Lorem ipsum dolor sit amet, Agile description here.",
  "AI Solutions": "Lorem ipsum dolor sit amet, AI description here.",
  "API Management": "Lorem ipsum dolor sit amet, API description here.",
  "Big Data": "Lorem ipsum dolor sit amet, Big Data description here.",
  "Blockchain Services": "Lorem ipsum dolor sit amet, Blockchain description here.",
  "Business Analytics": "Lorem ipsum dolor sit amet, Business Analytics description here.",
  "Cloud Computing": "Lorem ipsum dolor sit amet, Cloud Computing description here.",
  "CRM Tools": "Lorem ipsum dolor sit amet, CRM Tools description here.",
  "Cybersecurity": "Lorem ipsum dolor sit amet, Cybersecurity description here.",
  "Data Science": "Lorem ipsum dolor sit amet, Data Science description here.",
  "DevOps": "Lorem ipsum dolor sit amet, DevOps description here.",
  "Digital Marketing": "Lorem ipsum dolor sit amet, Digital Marketing description here.",
  "E-commerce": "Lorem ipsum dolor sit amet, E-commerce description here.",
  "ERP Systems": "Lorem ipsum dolor sit amet, ERP description here.",
  "Edge Computing": "Lorem ipsum dolor sit amet, Edge Computing description here.",
  "Finance Tools": "Lorem ipsum dolor sit amet, Finance description here.",
  "Fraud Detection": "Lorem ipsum dolor sit amet, Fraud Detection description here.",
  "File Storage": "Lorem ipsum dolor sit amet, File Storage description here.",
};
            ...
            {productsData[letter] && (
              <ul>
                {productsData[letter].map((product, idx) => (
                  <li key={idx} className="border-b border-black py-3">
                    <div
