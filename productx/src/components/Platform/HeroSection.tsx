...
const HeroSection = () => {
  return (
    <div className="w-full bg-[#83B0E6] py-20 mt-20 relative overflow-hidden">
     
   
      {/* Text Section */}
      <div className="px-8 sm:px-12 md:px-16 lg:px-20 xl:px-24 flex flex-col lg:flex-row justify-between items-center relative z-10">
        {/* Left Text */}
        <div className="w-full lg:pb-10 p-4 text-center lg:text-left">
